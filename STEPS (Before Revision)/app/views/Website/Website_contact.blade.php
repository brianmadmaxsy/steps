...
<link href="website/css/modify.css" rel="stylesheet" type="text/css" media="all" />
...
<!-- banner -->
	<div class="banner1">
		<div class="container">
			<h3 class="animated wow slideInLeft" data-wow-delay=".5s"><a href="http://localhost:8000/">Home</a> / <span>Contact</span></h3>
		</div>
	</div>
<!-- //banner -->
	<!--welcome-->
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3925.5870220941083!2d123.87873831416641!3d10.294820592649417!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33a99c06b6e866ad%3A0xbd795608a9d2278d!2sCebu+Institute+of+Techonology+University!5e0!3m2!1sen!2sph!4v1503556553409" allowfullscreen></iframe>

					</div>
					<div class="contact-grids">
						<div class="col-md-8 contact-grid">
							<h5>Fill out the form and we will get back to you within 24 hours</h5>
							<p>Kindly specify you name, email, contact number and your desire comments. LOCK team will love to hear from you. Cheers!</p>
							<form action="#" method="post">
								...
								<textarea type="text" name="textarea"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Concerns/Comments...';}" required="">Concerns/Comments...</textarea>
						...
						<div class="col-md-4 contact-grid1">
							...
							<div class="contact-top">
								<div class="agent-img">
									<img src="website/images/briansy.jpg" class="img-responsive" alt="">
								</div>
								<div class="agent-info">
									<h5>Lauren Brian L. Sy</h5>
									<h6>STEPS</h6>
								</div>
								<div class="clearfix"></div>
							</div>
							<ul>
									<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i> Office : (032) 262 7281</li>
									<li><i class="glyphicon glyphicon-phone" aria-hidden="true"></i> Mobile : +63 922 515 3605</li>
									<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i> <a href="#"><a href="mailto:info@example.com">stepscapstone@gmail.com</a></a></li>
									<li><i class="glyphicon glyphicon-print" aria-hidden="true"></i> Fax : (032) 262 7281</li>
								</ul>
