						    ...
						    <div class="row">
						        ...
						        <div class=" col-md-8 col-lg-8 "> 
						            <table class="table table-user-information">
						                <tbody>
						                    ...
						                    <tr>
						                    	<td>Status</td>
						                    	<?php
						                    	if($student['steps_status']=="evaluation")
						                    	{
						                    	?>
						                    ...
						                    ?>
				                    		<tr>
				                    			<td><h5><b>Evaluation Comment</b></h5></td>
					                        	<td class="alert alert-info">{{ $evaluation['comment'] }}</td>
											</tr>
											<?php
						                    }
						                    ?>	
						            ...
						            ?>
						          	<div style="height:auto;">
						          		<form method="post" action="/evaluation">
							          		<div>
							          			...
							          			<textarea name="comment" class="form-control" placeholder="Textarea" rows="5" style="width:500px;"></textarea>
							          		</div>
							          		<div style="margin-top:10px;">
							          			<input type="hidden" name="get_userid" value="{{ $student['userid'] }}">
							          			<input type="hidden" name="get_evaluator" value="{{ $college['username'] }}">
							          			<input type="submit" name="evaluate" class="btn btn-success btn-lg" value="Approve">
												<input type="submit" name="evaluate" class="btn btn-danger btn-lg" value="Decline">
						          	...
						          	?>
						          	<a href="http://localhost:8000/collegehome" class="btn btn-info" role="button">Back to Admin Page...</a>  
