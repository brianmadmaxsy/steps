							            ...
							            <div class="panel-body">
										    <div class="row">
										    	...
										    	<div class="col-md-4 col-lg-4 " align="center" > 
									    			...
									    			{
									    			?>
									    			<img alt="User Pic" src="<?php echo "profilepics/".$college['picture']; ?>" class="img-circle img-responsive" > 
									    			<?php
									    			}
									    			?>
										    	</div>
    	...
    	<div class="modal-content">
		    ...
		    <div class="modal-body">
		    	<div>
	    			...
	    			{
	    			?>
	    			<img alt="User Pic" src="<?php echo "profilepics/".$college['picture']; ?>" class="img-rounded img-responsive" style="margin:0px auto 0px auto;"> 
	    			<?php
	    			}
	    			?>
		 		</div>
