			            ...
			            <div class="panel-body">
						    <div class="row">
						        ...
						        <div class=" col-md-8 col-lg-8 "> 
						            ...
						            <form method="post" action="/claimfreshmenidentification">
						          		<table>
						          			<tr>
						          				<td colspan="2">
						          					<input type="hidden" name="get_userid" value="{{ $student['userid'] }}">
								          			<input type="hidden" name="get_oas_username" value="{{ $oas['username'] }}">
								          			<input type="submit" name="getidentificationbutton" class="btn btn-success btn-lg" value="Claimed Temporary ID">
													<input type="submit" name="getidentificationbutton" class="btn btn-danger btn-lg" value="Decline">
						          				</td>
						          			</tr>
						          		</table>
							        </form>	
