						        ...
						        <div class=" col-md-8 col-lg-8 "> 
						            ...
						            ?>
										...
										?>	
											...
											<form method="post" action="/submitfreshmenrequirements">
												<table>
													...
													?>
														<tr id="student_sao_table">
														    <td width="300">
														    	<label>High School Card (Grades)</label>
											...
											<form method="post" action="/approvefreshmenrequirements">
												<table>
						          	...
						          	elseif($student['steps_status']!="requirements") //if steps_status is not "requirements"(Step2) show this
						          	{
						          	?>
						          		<?php
							          	if($requirements['highschoolcard']=="false" || $requirements['GM']=="false" || $requirements['NSO']=="false" || $requirements['NCAE']=="false")
